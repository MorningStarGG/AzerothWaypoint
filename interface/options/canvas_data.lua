...
Data.OPTION_PREVIEWS = {
    ...
    ["Enable Tracker Viewer"] = {
        ...
        desc =
        "Shows Zygor guide steps inside the objective tracker. Kaliel's Tracker is recommended. Blizzard native docking is experimental, has known taint risk, may stop working after a WoW patch, and may be removed in the future.",
    },
    ["Show Native Docking Warning Popup"] = {
        image = MEDIA_HELP .. "TrackerViewer.tga",
        desc = "Shows the native-docking risk warning after login or reload when Tracker Viewer attaches to Blizzard's objective tracker.",
    },
...
Data.OPTIONS = {
    ...
    { key = "zygor",        label = "Enable Tracker Viewer",                     desc = "Show Zygor guide steps inside the active objective tracker. Kaliel's Tracker is recommended; Blizzard native docking is experimental and has known taint risk.",                            added = "4.1.0", updated = "4.1.2", note = "Blizzard native docking may stop working after a WoW patch and may be removed in favor of Kaliel's Tracker-only docking.", tags = "tracker viewer zygor guide step dock docked embed embedded replacement compact mini kaliel kalielstracker kt recommended blizzard experimental taint risk future removal quest frame objective tracker watched tracked enable" },
    { key = "zygor",        label = "Show Native Docking Warning Popup",          desc = "Show the experimental native-docking warning after login or reload when Tracker Viewer attaches to Blizzard's tracker.",                                added = "4.1.2", tags = "tracker viewer blizzard native docking warning popup reminder remind later login reload disable enable experimental taint risk kaliel" },
